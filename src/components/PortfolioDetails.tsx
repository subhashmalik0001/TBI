    ...
    return (
        <div className="flex-1 max-w-full md:max-w-lg md:mr-20 ">
            <div className="flex flex-wrap items-center gap-4 ml-20 mt-10 mb-20">
                ...
                <div className="text-gray-500 text-xs ml-2 md:text-sm">{stepLabel}</div>
                <div className="text-gray-400 text-xs ml-2">{stepCount}</div>
            </div>
            <h2 className="text-lg md:text-2xl ml-20 text-gray-800 font-semibold">{title}</h2>
            <p className="text-gray-500  ml-20 text-sm md:text-base">{description}</p>
            <ol className="mb-8 ml-20 text-gray-700">
