...
export default function StoryCard({
  ...
  return (
    <div className="bg-white rounded-[34px] shadow-lg p-1 max-w-sm mx-auto flex flex-col gap-4 border border-gray-100"
      ...
      <div className="px-4">
        ...
        <p className="text-[#A3A3A3] text-sm line-clamp-3">{description}</p>
      </div>
