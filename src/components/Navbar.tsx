    ...
    <header className={headerClasses}>
      <nav className="flex items-center justify-between relative min-h-[64px] pr-6">
        ...
        <Link href="/apply" legacyBehavior>
          <a
            className="mr-10 bg-red-600 text-white px-7 py-3 text-lg font-bold border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all duration-200 hidden md:inline-flex"
          >
            APPLY TO INCUBATOR
          </a>
        </Link>
